...
<tr>
	<td><a href="category_sort.php?<?=$funcLibrary->queryString()?>"><button type="button" class="black_icon_btn">순서관리</button></td>
</tr>
</table>
<br>
<table width="100%" cellpadding="0" cellspacing="0" class="adminMenuTable">
...
<tr class='bgcol1 bold col1 ht center'>
	...
	<td>분류코드</td>
	<td>사용유무</td>
	<td><button type="button" class="red_btn" onclick="window.location='./category_form.php?<?=$funcLibrary->queryString('w')?>w=a&depth=1'">1차 등록</button></td>
</tr>
<?php
	//1차 분류
