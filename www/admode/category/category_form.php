			...
			<td class="td2">
				<div class="file_list">
					...
					<?php if($d['file1']){?>
						...
						<br><img src="<?=$gh_path?>data/category/<?=$d['file1']?>" width="150" style="margin-top:10px;">
			...
			<td class="td2">
				<div class="file_list">
					...
					<?php if($d['file2']){?>
						...
						<br><img src="<?=$gh_path?>data/category/<?=$d['file2']?>" width="150" style="margin-top:10px;">
		...
		<tr class="ht">
			...
			<td class="td2">
				<div class="file_list">
					...
					<?php if($d['file1']){ ?>
					<input type="hidden" name="old_file1" value="<?=$d['file1']?>">
					<br><br><img src="<?=$gh_path?>data/category/<?=$d['file1']?>" width="150">
					<input type="checkbox" name="del_file1" value="<?=$d['file1']?>"> 삭제
					<?php }?>
				</div>
			</td>
