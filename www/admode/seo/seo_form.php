...
?>
<form name="fwrite" method="post" action="./seo_ok.php?<?=$func_library->queryString()?>" onsubmit="return fwrite_submit(this);" enctype="multipart/form-data" style="margin:0px;">
	...
	<td class="td2">
		<div class="file_list">
			...
			<?php if($d['file1']){?>
				...
				<br>
				<img src="<?=$gh_path?>data/seo/<?=$d['file1']?>" width="100" style="margin-top:5px;">
	...
	<td class="td2">
		<div class="file_list">
			...
			<?php if($d['file2']){?>
				...
				<br>
				<img src="<?=$gh_path?>data/seo/<?=$d['file2']?>" width="100" style="margin-top:5px;">
