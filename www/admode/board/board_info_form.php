...
?>
<form name="fwrite" method="post" action="./board_info_ok.php?<?=$funcLibrary->queryString()?>" onsubmit="return fwrite_submit(this);" enctype="multipart/form-data" style="margin:0px;">
...
<tr class="ht">
	...
	<td class="td2">
		<input type="text" name="boardID" class="input_text" style="width:150px;" value="<?=$d['bbsid']?>" required="required">
	</td>
</tr>
<tr><td colspan="2" class="line2"></td></tr>
<tr class="ht">
...
<p align="center" style="margin-top:30px;">
	...
	<button type="button" class="gray_btn" onclick="javascript:window.location='./board_info_list.php?<?=$funcLibrary->queryString('idx,w')?>'">취 소</button>
</p>
</form>
