...
<form name="sort_frm" method="post" action="./category_sort_ok.php?<?=$funcLibrary->queryString()?>" onsubmit="return fwrite_submit(this);" enctype="multipart/form-data" style="margin:0px;">
<div class="sort_area">
...
<p align="center" style="margin-top:50px;width:700px;">
	...
	<button type="button" class="gray_btn" onclick="javascript:window.location='./category_sort.php?menuCode=<?=$menuCode?>&cate=<?=$cate?>'">취 소</button>
</p>
</form>
